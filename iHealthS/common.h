...
// 主页列表接
#define INDEX_URL @"http://wp.asopeixun.com:5000/get_post_from_category_id?category_id=197"

// 左侧列表接口
//#define LEFT_URL @"http://wp01.asopeixun.com:5000/get_category_list?app_id=1"
#define LEFT_URL @"http://wp.asopeixun.com:5000/get_category_list?app_id=1124748781"
