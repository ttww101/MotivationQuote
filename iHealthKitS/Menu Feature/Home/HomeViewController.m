...
- (void)setContainerViewController {
    UIViewController *vc1 = [QuoteTypeTableViewController new];
    UIViewController *vc2 = [MyQuoteViewController new];
...
- (NSArray<UIImage *> *)tabBarImages {
    return @[[UIImage imageNamed:@"all_50x50_b"],
             [UIImage imageNamed:@"all_50x50_p"]];
}

- (UIColor *)tabBarColor {
    return [UIColor colorWithRed:0x1d/255.0 green:0x90/255.0 blue:0x7e/255.0 alpha:1.0];
}
...
- (void)setupNavigationStyle {
    NavigationTheme *theme = [[NavigationTheme alloc]
                              ...
                              //bar color
                              barColor:[UIColor colorWithRed:0x1d/255.0 green:0x90/255.0 blue:0x7e/255.0 alpha:1.0]
                              //title font, size
...
- (void)setupUI {
    ...
    [self.homeButton setImage:[UIImage imageNamed:@"all_50x50_h"] forState:UIControlStateNormal];
